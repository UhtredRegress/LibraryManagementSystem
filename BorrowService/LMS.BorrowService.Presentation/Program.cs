...
{
    cfg.RegisterServicesFromAssembly(typeof(LMS.BorrowService.Application.AssemblyMarker).Assembly);
});

builder.Services.AddValidatorsFromAssembly(typeof(LMS.BorrowService.Application.AssemblyMarker).Assembly);
